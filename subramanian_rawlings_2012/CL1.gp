...
set xtics 10
set ytics 10
set ylabel "Level in Tank-2"
set xlabel "Time"
set key 
#set key horizontal samplen 2
#unset key
set label "$S_K(\\infty)$ bound" at 25,8
...
set xlabel "time"
unset label
plot "CL1.dat" index 1 u 1:2 w l ls 1 axis x1y2 t "$V_N(x,\\tilde{\\mathbf{v}})$",\
"" index 1 u 1:3 w l ls 3 axis x1y2 t "$V_N(z,\\tilde{\\mathbf{v}})$",\
